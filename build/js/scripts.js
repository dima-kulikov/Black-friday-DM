...
function time() {
  ...
  var thour = today % 24;
  today = Math.floor(today / 24); // Присваеваем код под нужный id

  document.getElementById('day-num').innerHTML = today;
  document.getElementById('day-text').innerHTML = getNoun(today, 'день', 'дня', 'дней'); // document.getElementById('day').innerHTML=today + " дней ";
